...
def _pass():
    """ this function to check if the flappy pass the pipe or not"""
...
def check_collision(bird_group, pipe_group, flappy):
    ...
    if pygame.sprite.groupcollide(bird_group, pipe_group, False, False) \
        ...
        # flappy.rect.top < 0 (means he cracked the top of the screen)
        game_over = True
...
def Game_Over():
    """This function to check continuity of the Whole Game"""
...
while run:
    ...
    # control the speed of scrolling_ground_img
    clock.tick(fps)
